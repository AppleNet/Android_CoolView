package com.llc.android_coolview.kobe.view.seekbar;
...
public class SeekBarPressure extends View {
    ...
    public SeekBarPressure(Context context, AttributeSet attrs, int defStyle) {
        ...
        mScollBarWidth=a.getLayoutDimension(R.styleable.SeekBarPressure_seek_width, "layout_width");
        mScollBarHeight = a.getLayoutDimension(R.styleable.SeekBarPressure_seek_height, "layout_height");
    ...
    public void init(Context context) {
        ...
        mScrollBarBgNormal = getResources().getDrawable(R.drawable.station_line_gray);
        mScrollBarProgress = getResources().getDrawable(R.drawable.station_line_blue);
        mThumbLow = getResources().getDrawable(R.drawable.kobe_tickets_seekbar);
        mThumbHigh = getResources().getDrawable(R.drawable.kobe_tickets_seekbar);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mScrollBarBgNormal.setBounds(0, 60, mScollBarWidth, mThumbHeight);
        mScrollBarBgNormal.draw(canvas);

        mScrollBarProgress.setBounds(0 , 60 , mScollBarWidth, mThumbHeight);
        mScrollBarProgress.draw(canvas);

        mThumbLow.setBounds(mOffsetLow, 30 , mOffsetLow+mThumbWidth,mThumbHeight+30);
        mThumbLow.draw(canvas);

        mThumbHigh.setBounds(mOffsetHigh, 30 , mOffsetHigh+mThumbWidth,mThumbHeight+30);
