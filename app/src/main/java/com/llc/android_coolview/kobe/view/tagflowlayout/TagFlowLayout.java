package com.llc.android_coolview.kobe.view.tagflowlayout;
...
import com.llc.android_coolview.kobe.view.tagflowlayout.TagAdapter.OnDataChangedListener;
...
public class TagFlowLayout extends FlowLayout implements OnDataChangedListener {
    ...
    public void setOnTagClickListener(OnTagClickListener mOnTagClickListener){
        ...
        if(mOnTagClickListener!=null) setClickable(true);
    }

    public void setAdatper(TagAdapter adapter){
        mTagAdapter=adapter;
