...
public class JSONUtil {
	...
	public static String SIMPLE_DATETIME = "yyyyMMddHHmmss";
	...
	public static String toJson(Object target, Type targetType, boolean isSerializeNulls, Double version,
		...
		builder.registerTypeAdapter(Date.class, new TimeTypeAdapter(datePattern));
		String result = EMPTY;
	...
	public static String toJson(Object target) {
		return toJson(target, null, false, null, SIMPLE_DATETIME, true);
	}
	...
	public static <T> T fromJson(String json, TypeToken<T> token) {
		return fromJson(json, token, SIMPLE_DATETIME);
	}
	...
	public static <T> T fromJson(String json, Class<T> clazz) {
		return fromJson(json, clazz, SIMPLE_DATETIME);
	}
	...
	private static class TimeTypeAdapter implements JsonSerializer<Date>, JsonDeserializer<Date> {

		private String datePattern;

		public TimeTypeAdapter(String datePattern) {
			super();
