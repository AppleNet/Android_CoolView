...
import com.llc.android_coolview.adatper.SimpleHeaderRecyclerAdapter;
import com.llc.android_coolview.adatper.SimpleRecyclerAdapter;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> getDummyData(int num) {
        ...
        for (int i = 0; i <Constant.cityList.length; i++) {
            items.add(Constant.cityList[i]);
        }
        return items;
    }
    ...
    protected void setDummyData(GridView gridView) {
        gridView.setAdapter(new ArrayAdapter<>(this, R.layout.activity_kobe_fragment_weather_tv, getDummyData()));
    }
