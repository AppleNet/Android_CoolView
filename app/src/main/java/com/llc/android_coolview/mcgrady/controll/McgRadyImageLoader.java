...
import com.llc.android_coolview.util.DownloadImgUtils;
import com.llc.android_coolview.util.ImageSizeUtil;
import com.llc.android_coolview.util.ImageSizeUtil.ImageSize;
 ...
 * 
 */
public class McgRadyImageLoader {
	private static McgRadyImageLoader mInstance;
	...
	private McgRadyImageLoader(int threadCount, Type type) {
	...
	public static McgRadyImageLoader getInstance() {
		if (mInstance == null) {
			synchronized (McgRadyImageLoader.class) {
				if (mInstance == null) {
					mInstance = new McgRadyImageLoader(DEAFULT_THREAD_COUNT, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	public static McgRadyImageLoader getInstance(int threadCount, Type type) {
		if (mInstance == null) {
			synchronized (McgRadyImageLoader.class) {
				if (mInstance == null) {
					mInstance = new McgRadyImageLoader(threadCount, type);
				}
			}
		}
		return mInstance;
