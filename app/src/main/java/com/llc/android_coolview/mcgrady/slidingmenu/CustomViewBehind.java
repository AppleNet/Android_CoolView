package com.llc.android_coolview.mcgrady.slidingmenu;

import com.llc.android_coolview.R;
import com.llc.android_coolview.mcgrady.slidingmenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	public int getSecondaryContentWidth() {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mSecondaryContent != null){
			...
			mSecondaryContent.layout(0, 0, width-220, height);
		}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mSecondaryContent != null){
			final int width1 = getChildMeasureSpec(widthMeasureSpec, 0, width-220);
			final int height1 = getChildMeasureSpec(heightMeasureSpec, 0, height);
			mSecondaryContent.measure(width1, height1);
	...
	public void scrollBehindTo(View content, int x, int y) {
		...
		if (mMode == SlidingMenu.LEFT) {
			...
			if (x <= content.getLeft()) {				
				...
				scrollTo((int)(getSecondaryContentWidth() - getWidth() + (x-getSecondaryContentWidth())*mScrollScale), y);	
			}
		}
	...
	public int getMenuLeft(View content, int page) {
		if (mMode == SlidingMenu.LEFT) {
			...
			case 0:
				return content.getLeft() - getBehindWidth();
			case 2:				
				return content.getLeft() + getSecondaryContentWidth();
			}
		}
		return content.getLeft();
	}
