package com.llc.android_coolview.wade.view.finder;
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			if ((WadeQRActivity.currentState != null) && (WadeQRActivity.currentState.equals("onecode"))) {
				canvas.drawText(getResources().getString(R.string.scan_onecode),frame.left + 8, (float) (frame.bottom + (float) 40* density), paint);
			}
			if ((WadeQRActivity.currentState != null) && (WadeQRActivity.currentState.equals("qrcode"))) {
